...
export default function Hero() {
  ...
  <span className={highlightClass}>diseño</span>, <span className={highlightClass}>rendimiento</span> y{' '}
  <span className={highlightClass}>tecnología moderna</span> para construir productos rápidos, escalables y
  visualmente sólidos.
  <br />
  <br />
  ...
  <br />
  <br />
  Además, desarrollo <span className={highlightClass}>automatizaciones avanzadas</span> con{' '}
  ...
  <span className={highlightClass}>experiencia digital</span> en una sola visión.
</p>
      </div>
    </motion.section>
  )
